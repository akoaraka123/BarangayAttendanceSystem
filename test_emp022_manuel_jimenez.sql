-- Test SQL for Manuel Jimenez (EMP022) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP022 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP022';

-- Insert attendance logs for Manuel Jimenez (10 days, days 1-10)
