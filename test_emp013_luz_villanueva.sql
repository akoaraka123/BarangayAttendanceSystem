-- Test SQL for Luz Villanueva (EMP013) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP013 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP013';

-- Insert attendance logs for Luz Villanueva (10 days, days 1-10)
