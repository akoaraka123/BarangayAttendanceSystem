-- Test SQL for Carmen Lopez (EMP009) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP009 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP009';

-- Insert attendance logs for Carmen Lopez (10 days, days 1-10)
