-- Test SQL for Antonio Mendoza (EMP014) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP014 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP014';

-- Insert attendance logs for Antonio Mendoza (10 days, days 1-10)
