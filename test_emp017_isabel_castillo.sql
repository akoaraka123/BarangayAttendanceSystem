-- Test SQL for Isabel Castillo (EMP017) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP017 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP017';

-- Insert attendance logs for Isabel Castillo (10 days, days 1-10)
