-- Test SQL for Jose Navarro (EMP020) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP020 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP020';

-- Insert attendance logs for Jose Navarro (10 days, days 1-10)
