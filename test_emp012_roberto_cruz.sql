-- Test SQL for Roberto Cruz (EMP012) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP012 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP012';

-- Insert attendance logs for Roberto Cruz (10 days, days 1-10)
