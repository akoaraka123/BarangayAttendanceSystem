-- Test SQL for Ricardo Morales (EMP018) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP018 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP018';

-- Insert attendance logs for Ricardo Morales (10 days, days 1-10)
