-- Test SQL for Patricia Gutierrez (EMP019) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP019 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP019';

-- Insert attendance logs for Patricia Gutierrez (10 days, days 1-10)
