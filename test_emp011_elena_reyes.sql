-- Test SQL for Elena Reyes (EMP011) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP011 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP011';

-- Insert attendance logs for Elena Reyes (10 days, days 1-10)
