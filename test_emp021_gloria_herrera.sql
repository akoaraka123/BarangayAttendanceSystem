-- Test SQL for Gloria Herrera (EMP021) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP021 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP021';

-- Insert attendance logs for Gloria Herrera (10 days, days 1-10)
