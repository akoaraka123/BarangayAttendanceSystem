-- Test SQL for Miguel Torres (EMP010) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP010 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP010';

-- Insert attendance logs for Miguel Torres (10 days, days 1-10)
