-- Test SQL for Rosa Martinez (EMP007) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP007 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP007';

-- Insert attendance logs for Rosa Martinez (10 days, days 1-10)
