-- Test SQL for Sofia Ramos (EMP015) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP015 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP015';

-- Insert attendance logs for Sofia Ramos (10 days, days 1-10)
