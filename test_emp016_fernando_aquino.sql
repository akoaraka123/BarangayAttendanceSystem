-- Test SQL for Fernando Aquino (EMP016) only
-- Run this in MySQL/XAMPP phpMyAdmin

USE attendance_db;

-- Delete existing attendance logs for EMP016 first
DELETE FROM attendance_logs WHERE employee_id = 'EMP016';

-- Insert attendance logs for Fernando Aquino (10 days, days 1-10)
